...
/* =========================================================
   LOAD / CREATE DAILY TEAMMATE GAME
========================================================= */
...
async function loadTeammateDailyGame() {
    ...
    const { data: insertedGame, error: insertError } =
        await db
        .from("teammateGames")
        .insert({
    ...
    /*
     * Another user may have created the game
     * at the same time.
     */
    ...
    if (insertError) {
        ...
        if (
            ...
            console.log(
                "Game was created by another client. Reloading..."
            );


            const { data: existingGame, error: reloadError } =
                await db
                .from("teammateGames")
                .select("*")
                .eq("date", teammateSelectedDate)
            ...
            teammateStartPlayer = {
                ...
                id:
                    Number(existingGame.startPlayerId),
            ...
            teammateEndPlayer = {
                ...
                id:
                    Number(existingGame.endPlayerId),
    ...
    teammateStartPlayer = {
        ...
        id:
            Number(insertedGame.startPlayerId),
    ...
    teammateEndPlayer = {
        ...
        id:
            Number(insertedGame.endPlayerId),
...
async function initializeTeammateGame() {
    ...
    try {
        ...
        /*
         * Load the game for the URL date.
         *
         * If it doesn't exist, this creates it
         * and stores the Start/End players.
         */
